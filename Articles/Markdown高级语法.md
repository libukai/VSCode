...
+ MPE 还可以直接在 Markdown 文档中嵌入 EXCEL 文件，有兴趣的朋友请关注《超级语法》。
...
升职会有的，加薪也会有的；Word 有的，Markdown 也会有的。比如批注功能的出现，就让这句话从传说变成了现实。

MPE 中支持 Critic Markup Syntax，可以支持对标 Word 的各种标记样式。需要注意的是，注释样式只在 Markdown 文档中可见，在预览或者生成的文档中不可见。
